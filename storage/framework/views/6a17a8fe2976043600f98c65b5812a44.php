...
=======
    <div class="header">
        ...
        <p>No. Transaksi: <?php echo e($record->no_transaksi); ?></p>
    </div>
    ...
    <table class="info-table">
        ...
        <tr>
            <th>Tanggal Masuk</th>
            <td><?php echo e(\Carbon\Carbon::parse($record->tanggal)->format('d F Y')); ?></td>
        </tr>
        <tr>
            <th>Nama Barang</th>
            <td><?php echo e($record->barang->nama_barang); ?></td>
...
</html><?php /**PATH C:\Users\Imron\BackendInven\resources\views/pdf/barang-masuk-single.blade.php ENDPATH**/ ?>
>>>>>>> baa15da68b8856f3a677b8ed495c2837fe58ff7e
