...
<body class="bg-gray-50 flex items-center justify-center h-screen">
    ...
    <div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
        ...
        <p class="text-center text-sm mt-4">
            Belum punya akun?
            <a href="<?php echo e(route('register.form')); ?>" class="text-blue-600 hover:underline">Daftar di sini</a>
        </p>
    </div>
...
<?php /**PATH C:\xampp\htdocs\BackendInven\resources\views/public/login.blade.php ENDPATH**/ ?>