<?php if(isset($data)): ?>
    <script>
        window.filamentData = <?php echo \Illuminate\Support\Js::from(data: $data)->toHtml() ?>
    </script>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\BackendInven\resources\views/vendor/filament/assets.blade.php ENDPATH**/ ?>